...
if(isset($_POST['login']))
{
	...
	try{
		...
		$que="select * from admininfo where username='$_POST[username]' and password='$_POST[password]' and type='$_POST[type]'";
		$row=0;
		$result=mysqli_query(mysqli_connect('localhost','root',''),$que);
